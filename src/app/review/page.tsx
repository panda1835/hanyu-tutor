...
export default function ReviewPage() {
  ...
  const handleAnswer = async (correct: boolean) => {
    ...
    try {
      ...
      const newIntervalIndex = getNextIntervalIndex(progress.interval_index, correct)
        ...
        <div className="mb-6 rounded-2xl border border-border bg-card p-4">
          ...
          <div className="progress-bar mt-2">
            <div 
              ...
              style={{ width: `${Math.min((reviewedToday / dailyGoal) * 100, 100)}%` }}
            />
          </div>
        ...
        {loading ? (
          ...
          <>
            ...
            <div className="mb-4 text-center text-sm text-muted-foreground">
              {remainingReviews} review{remainingReviews !== 1 ? 's' : ''} remaining
            ...
            <div className="animate-fade-in" key={currentReview.progress.id}>
              <Flashcard
                ...
                mode="review"
                intervalDays={getIntervalDays(currentReview.progress.interval_index)}
                isBookmarked={bookmarkedWords.has(currentReview.vocabulary.character)}
