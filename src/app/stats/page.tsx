              ...
              <div className="paper-card">
                ...
                <div className="progress-bar mt-3">
                  <div
                    ...
                    style={{
                      width: `${Math.min(
                        (stats.newWordsToday / stats.dailyNewGoal) * 100,
                        100
                      )}%`,
                    }}
                  />
              ...
              <div className="paper-card">
                ...
                <div className="progress-bar mt-3">
                  <div
                    ...
                    style={{
                      width: `${Math.min(
                        (stats.reviewsToday / stats.dailyReviewGoal) * 100,
                        100
                      )}%`,
                    }}
                  />
              ...
              <div className="paper-card">
                ...
                <div className="relative h-4 w-full overflow-hidden rounded-full bg-muted">
                  <div
                    ...
                    style={{
                      width: `${(stats.totalLearning / totalWords) * 100}%`,
                    }}
                  />
                  <div
                  ...
                  <div
                    ...
                    style={{
                      left: `${
                        ((stats.totalLearning + stats.totalReviewing) /
                          totalWords) *
                        100
                      }%`,
                ...
                <div className="mt-3 flex flex-wrap gap-4 text-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-muted-foreground">
                      Learning (
                      {Math.round((stats.totalLearning / totalWords) * 100)}%)
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-muted-foreground">
                      Reviewing (
                      {Math.round((stats.totalReviewing / totalWords) * 100)}%)
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-muted-foreground">
                      Mastered (
                      {Math.round((stats.totalMastered / totalWords) * 100)}%)
                    </span>
                  </div>
                </div>
              </div>
